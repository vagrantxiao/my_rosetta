...
#ifndef a0_start_for_dataflobek_HH_
#define a0_start_for_dataflobek_HH_

#include <systemc>
using namespace std;
SC_MODULE(a0_start_for_dataflobek) {
    static const unsigned int DATA_WIDTH = 1;
    static const unsigned int ADDR_WIDTH = 2;
    static const unsigned int a0_start_for_dataflobek_depth = 3;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[a0_start_for_dataflobek_depth];
    ...
    SC_CTOR(a0_start_for_dataflobek) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < a0_start_for_dataflobek_depth; i++) {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (a0_start_for_dataflobek_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < a0_start_for_dataflobek_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (a0_start_for_dataflobek_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > a0_start_for_dataflobek_depth) {
...
#endif //a0_start_for_dataflobek_HH_
