...
#ifndef _a0_dataflow_in_loop_IfE_H_
#define _a0_dataflow_in_loop_IfE_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "a0_dataflow_in_loop_IfE_memcore.h"

SC_MODULE(a0_dataflow_in_loop_IfE) {
...
protected:
    ...
    a0_dataflow_in_loop_IfE_memcore* a0_dataflow_in_loop_IfE_memcore_U;
...
public:
    ...
    SC_CTOR(a0_dataflow_in_loop_IfE) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        a0_dataflow_in_loop_IfE_memcore_U = new a0_dataflow_in_loop_IfE_memcore("a0_dataflow_in_loop_IfE_memcore_U");
        a0_dataflow_in_loop_IfE_memcore_U->clk      ( clk );
        a0_dataflow_in_loop_IfE_memcore_U->reset    ( reset );
        a0_dataflow_in_loop_IfE_memcore_U->ce0      ( i_ce0 );
        a0_dataflow_in_loop_IfE_memcore_U->we0      ( i_we0 );
        a0_dataflow_in_loop_IfE_memcore_U->address0 ( memcore_iaddr );
        a0_dataflow_in_loop_IfE_memcore_U->d0       ( i_d0 );
        a0_dataflow_in_loop_IfE_memcore_U->q0       ( i_q0 );

        a0_dataflow_in_loop_IfE_memcore_U->ce1      ( t_ce0 );
        a0_dataflow_in_loop_IfE_memcore_U->we1      ( t_we0 );
        a0_dataflow_in_loop_IfE_memcore_U->address1 ( memcore_taddr );
        a0_dataflow_in_loop_IfE_memcore_U->d1       ( t_d0 );
        a0_dataflow_in_loop_IfE_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "a0_dataflow_in_loop_IfE.trace");
            // ports
