...
set sdx_kernel_files {/home/ylxiao_seas_upenn_edu/Roseetta/rosetta/spam-filter/src/sdsoc/sgd.cpp}
set enable_xo_gen 0
...
set Interfaces {
    ap_clk {
        ...
        buses "m_axi_label_r m_axi_theta"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_label_r {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_label_r"
        data_width "32"
        param_prefix "C_M_AXI_LABEL_R"
    ...
    m_axi_theta {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_theta"
        data_width "64"
        param_prefix "C_M_AXI_THETA"
...
## System Info
set user_parameters_list {clk_period 10.001 machine 64 combinational 0 latency 1165609 II x}
