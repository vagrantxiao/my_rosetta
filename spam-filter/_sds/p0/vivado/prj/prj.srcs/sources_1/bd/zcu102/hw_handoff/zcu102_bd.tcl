...
proc create_root_design { parentCell } {
  ...
  # Create instance: SgdLR_1, and set properties
  set SgdLR_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:SgdLR:1.0 SgdLR_1 ]

  # Create instance: SgdLR_1_if, and set properties
  ...
  connect_bd_intf_net -intf_net SgdLR_1_data_V [get_bd_intf_pins SgdLR_1/data_V] [get_bd_intf_pins SgdLR_1_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net SgdLR_1_if_M_AXIMM_0 [get_bd_intf_pins SgdLR_1_if/M_AXIMM_0] [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_AXI]
  connect_bd_intf_net -intf_net SgdLR_1_if_M_AXIMM_1 [get_bd_intf_pins SgdLR_1_if/M_AXIMM_1] [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP2_FPD/S00_AXI]
  connect_bd_intf_net -intf_net SgdLR_1_if_ap_ctrl [get_bd_intf_pins SgdLR_1/ap_ctrl] [get_bd_intf_pins SgdLR_1_if/ap_ctrl]
  connect_bd_intf_net -intf_net SgdLR_1_m_axi_label_r [get_bd_intf_pins SgdLR_1/m_axi_label_r] [get_bd_intf_pins SgdLR_1_if/AP_AXIMM_0]
  connect_bd_intf_net -intf_net SgdLR_1_m_axi_theta [get_bd_intf_pins SgdLR_1/m_axi_theta] [get_bd_intf_pins SgdLR_1_if/AP_AXIMM_1]
  connect_bd_intf_net -intf_net axi_ic_ps_e_M_AXI_HPM0_FPD_M00_AXI [get_bd_intf_pins SgdLR_1_if/S_AXI] [get_bd_intf_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_AXI]
  ...
  connect_bd_intf_net -intf_net axis_ic_dm_0_M00_AXIS [get_bd_intf_pins SgdLR_1_if/S_AXIS_FIFO_0] [get_bd_intf_pins axis_ic_dm_0/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net dm_0_M_AXI_MM2S [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP1_FPD/S00_AXI] [get_bd_intf_pins dm_0/M_AXI_MM2S]
  connect_bd_intf_net -intf_net dm_0_M_AXI_SG [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP1_FPD/S01_AXI] [get_bd_intf_pins dm_0/M_AXI_SG]
  ...
  connect_bd_net -net SgdLR_1_if_ap_clk [get_bd_pins SgdLR_1/ap_clk] [get_bd_pins SgdLR_1_if/ap_clk]
  connect_bd_net -net SgdLR_1_if_ap_iscalar_0_dout [get_bd_pins SgdLR_1/label_V] [get_bd_pins SgdLR_1_if/ap_iscalar_0_dout]
  connect_bd_net -net SgdLR_1_if_ap_iscalar_1_dout [get_bd_pins SgdLR_1/theta_V] [get_bd_pins SgdLR_1_if/ap_iscalar_1_dout]
  connect_bd_net -net SgdLR_1_if_ap_iscalar_2_dout [get_bd_pins SgdLR_1/readLabels] [get_bd_pins SgdLR_1_if/ap_iscalar_2_dout]
  connect_bd_net -net SgdLR_1_if_ap_iscalar_3_dout [get_bd_pins SgdLR_1/writeOutput] [get_bd_pins SgdLR_1_if/ap_iscalar_3_dout]
  connect_bd_net -net SgdLR_1_if_ap_resetn [get_bd_pins SgdLR_1/ap_rst_n] [get_bd_pins SgdLR_1_if/ap_resetn]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins SgdLR_1_if/acc_aclk] [get_bd_pins SgdLR_1_if/s_axi_aclk] [get_bd_pins SgdLR_1_if/s_axis_fifo_0_aclk] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M01_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S01_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/S00_ACLK] [get_bd_pins axis_ic_dm_0/ACLK] [get_bd_pins axis_ic_dm_0/M00_AXIS_ACLK] [get_bd_pins axis_ic_dm_0/S00_AXIS_ACLK] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins dm_0/m_axi_mm2s_aclk] [get_bd_pins dm_0/m_axi_sg_aclk] [get_bd_pins dm_0/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e/maxihpm0_fpd_aclk] [get_bd_pins ps_e/saxihp0_fpd_aclk] [get_bd_pins ps_e/saxihp1_fpd_aclk] [get_bd_pins ps_e/saxihp2_fpd_aclk] [get_bd_pins sgdma2axis_dm_0/clk]
  ...
  connect_bd_net -net dm_0_mm2s_introut [get_bd_pins dm_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M01_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S01_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/S00_ARESETN] [get_bd_pins axis_ic_dm_0/ARESETN] [get_bd_pins axis_ic_dm_0/M00_AXIS_ARESETN] [get_bd_pins axis_ic_dm_0/S00_AXIS_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins SgdLR_1_if/acc_aresetn] [get_bd_pins SgdLR_1_if/s_axi_aresetn] [get_bd_pins SgdLR_1_if/s_axis_fifo_0_aresetn] [get_bd_pins dm_0/axi_resetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins sgdma2axis_dm_0/arstn]
  ...
  create_bd_addr_seg -range 0x00010000000000000000 -offset 0x00000000 [get_bd_addr_spaces SgdLR_1/Data_m_axi_label_r] [get_bd_addr_segs SgdLR_1_if/AP_AXIMM_0/reg0] SEG_SgdLR_1_if_reg0
  create_bd_addr_seg -range 0x00010000000000000000 -offset 0x00000000 [get_bd_addr_spaces SgdLR_1/Data_m_axi_theta] [get_bd_addr_segs SgdLR_1_if/AP_AXIMM_1/reg0] SEG_SgdLR_1_if_reg0
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_0] [get_bd_addr_segs ps_e/SAXIGP2/HP0_DDR_HIGH] SEG_ps_e_HP0_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_0] [get_bd_addr_segs ps_e/SAXIGP2/HP0_DDR_LOW] SEG_ps_e_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_0] [get_bd_addr_segs ps_e/SAXIGP2/HP0_LPS_OCM] SEG_ps_e_HP0_LPS_OCM
  create_bd_addr_seg -range 0x000200000000 -offset 0x000600000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_0] [get_bd_addr_segs ps_e/SAXIGP2/HP0_PCIE_HIGH1] SEG_ps_e_HP0_PCIE_HIGH1
  create_bd_addr_seg -range 0x004000000000 -offset 0x008000000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_0] [get_bd_addr_segs ps_e/SAXIGP2/HP0_PCIE_HIGH2] SEG_ps_e_HP0_PCIE_HIGH2
  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_0] [get_bd_addr_segs ps_e/SAXIGP2/HP0_PCIE_LOW] SEG_ps_e_HP0_PCIE_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_0] [get_bd_addr_segs ps_e/SAXIGP2/HP0_QSPI] SEG_ps_e_HP0_QSPI
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_1] [get_bd_addr_segs ps_e/SAXIGP4/HP2_DDR_HIGH] SEG_ps_e_HP2_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_1] [get_bd_addr_segs ps_e/SAXIGP4/HP2_DDR_LOW] SEG_ps_e_HP2_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_1] [get_bd_addr_segs ps_e/SAXIGP4/HP2_LPS_OCM] SEG_ps_e_HP2_LPS_OCM
  create_bd_addr_seg -range 0x000200000000 -offset 0x000600000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_1] [get_bd_addr_segs ps_e/SAXIGP4/HP2_PCIE_HIGH1] SEG_ps_e_HP2_PCIE_HIGH1
  create_bd_addr_seg -range 0x004000000000 -offset 0x008000000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_1] [get_bd_addr_segs ps_e/SAXIGP4/HP2_PCIE_HIGH2] SEG_ps_e_HP2_PCIE_HIGH2
  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_1] [get_bd_addr_segs ps_e/SAXIGP4/HP2_PCIE_LOW] SEG_ps_e_HP2_PCIE_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces SgdLR_1_if/M_AXIMM_1] [get_bd_addr_segs ps_e/SAXIGP4/HP2_QSPI] SEG_ps_e_HP2_QSPI
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_DDR_HIGH] SEG_ps_e_HP1_DDR_HIGH
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces dm_0/Data_MM2S] [get_bd_addr_segs ps_e/SAXIGP3/HP1_DDR_HIGH] SEG_ps_e_HP1_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_DDR_LOW] SEG_ps_e_HP1_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_0/Data_MM2S] [get_bd_addr_segs ps_e/SAXIGP3/HP1_DDR_LOW] SEG_ps_e_HP1_DDR_LOW
  create_bd_addr_seg -range 0x000200000000 -offset 0x000600000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_PCIE_HIGH1] SEG_ps_e_HP1_PCIE_HIGH1
  create_bd_addr_seg -range 0x000200000000 -offset 0x000600000000 [get_bd_addr_spaces dm_0/Data_MM2S] [get_bd_addr_segs ps_e/SAXIGP3/HP1_PCIE_HIGH1] SEG_ps_e_HP1_PCIE_HIGH1
  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_PCIE_LOW] SEG_ps_e_HP1_PCIE_LOW
  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces dm_0/Data_MM2S] [get_bd_addr_segs ps_e/SAXIGP3/HP1_PCIE_LOW] SEG_ps_e_HP1_PCIE_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_QSPI] SEG_ps_e_HP1_QSPI
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces dm_0/Data_MM2S] [get_bd_addr_segs ps_e/SAXIGP3/HP1_QSPI] SEG_ps_e_HP1_QSPI
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs SgdLR_1_if/S_AXI/reg0] SEG_SgdLR_1_if_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0010000 [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs dm_0/S_AXI_LITE/Reg] SEG_dm_0_Reg

  # Exclude Address Segments
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_0/Data_MM2S] [get_bd_addr_segs ps_e/SAXIGP3/HP1_LPS_OCM] SEG_ps_e_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_0/Data_MM2S/SEG_ps_e_HP1_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_LPS_OCM] SEG_ps_e_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_0/Data_SG/SEG_ps_e_HP1_LPS_OCM]
