...
proc create_root_design { parentCell } {
  ...
  # Create instance: DigitRec_1, and set properties
  set DigitRec_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:DigitRec:1.0 DigitRec_1 ]

  # Create instance: DigitRec_1_if, and set properties
  set DigitRec_1_if [ create_bd_cell -type ip -vlnv xilinx.com:ip:adapter_v3_0:1.0 DigitRec_1_if ]
  set_property -dict [ list \
   CONFIG.C_INPUT_SCALAR_0_WIDTH {32} \
   CONFIG.C_NUM_INPUT_BRAMs {2} \
   CONFIG.C_NUM_OUTPUT_BRAMs {1} \
   CONFIG.C_N_INPUT_SCALARS {1} \
   CONFIG.M_AXIS_BRAM_0_DEPTH {2000} \
   CONFIG.M_AXIS_BRAM_0_DMWIDTH {8} \
   CONFIG.M_AXIS_BRAM_0_MB_DEPTH {1} \
   CONFIG.M_AXIS_BRAM_0_WIDTH {8} \
   CONFIG.S_AXIS_BRAM_0_DEPTH {9000} \
   CONFIG.S_AXIS_BRAM_0_DMWIDTH {256} \
   CONFIG.S_AXIS_BRAM_0_MB_DEPTH {1} \
   CONFIG.S_AXIS_BRAM_0_WIDTH {256} \
   CONFIG.S_AXIS_BRAM_1_DEPTH {2000} \
   CONFIG.S_AXIS_BRAM_1_DMWIDTH {256} \
   CONFIG.S_AXIS_BRAM_1_MB_DEPTH {1} \
   CONFIG.S_AXIS_BRAM_1_WIDTH {256} \
 ] $DigitRec_1_if
  ...
  connect_bd_intf_net -intf_net DigitRec_1_global_results_PORTA [get_bd_intf_pins DigitRec_1/global_results_PORTA] [get_bd_intf_pins DigitRec_1_if/AP_BRAM_OARG_0_0]
  connect_bd_intf_net -intf_net DigitRec_1_global_test_set_V_PORTA [get_bd_intf_pins DigitRec_1/global_test_set_V_PORTA] [get_bd_intf_pins DigitRec_1_if/AP_BRAM_IARG_1_0]
  connect_bd_intf_net -intf_net DigitRec_1_global_training_set_V_PORTA [get_bd_intf_pins DigitRec_1/global_training_set_V_PORTA] [get_bd_intf_pins DigitRec_1_if/AP_BRAM_IARG_0_0]
  connect_bd_intf_net -intf_net DigitRec_1_if_M_AXIS_BRAM_0 [get_bd_intf_pins DigitRec_1_if/M_AXIS_BRAM_0] [get_bd_intf_pins axis_dwc_dm_2_rx_0/S_AXIS]
  connect_bd_intf_net -intf_net DigitRec_1_if_ap_ctrl [get_bd_intf_pins DigitRec_1/ap_ctrl] [get_bd_intf_pins DigitRec_1_if/ap_ctrl]
  connect_bd_intf_net -intf_net axi_ic_ps_e_M_AXI_HPM0_FPD_M00_AXI [get_bd_intf_pins DigitRec_1_if/S_AXI] [get_bd_intf_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_AXI]
  ...
  connect_bd_intf_net -intf_net axis_dwc_dm_0_tx_0_M_AXIS [get_bd_intf_pins DigitRec_1_if/S_AXIS_BRAM_0] [get_bd_intf_pins axis_dwc_dm_0_tx_0/M_AXIS]
  connect_bd_intf_net -intf_net axis_dwc_dm_1_tx_0_M_AXIS [get_bd_intf_pins DigitRec_1_if/S_AXIS_BRAM_1] [get_bd_intf_pins axis_dwc_dm_1_tx_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net dm_1_M_AXI_MM2S [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_AXI] [get_bd_intf_pins dm_1/M_AXI_MM2S]
  connect_bd_intf_net -intf_net dm_2_M_AXI_S2MM [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP2_FPD/S00_AXI] [get_bd_intf_pins dm_2/M_AXI_S2MM]
  ...
  connect_bd_net -net DigitRec_1_if_ap_clk [get_bd_pins DigitRec_1/ap_clk] [get_bd_pins DigitRec_1_if/ap_clk]
  connect_bd_net -net DigitRec_1_if_ap_iscalar_0_dout [get_bd_pins DigitRec_1/run] [get_bd_pins DigitRec_1_if/ap_iscalar_0_dout]
  connect_bd_net -net DigitRec_1_if_ap_resetn [get_bd_pins DigitRec_1/ap_rst_n] [get_bd_pins DigitRec_1_if/ap_resetn]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins DigitRec_1_if/acc_aclk] [get_bd_pins DigitRec_1_if/m_axis_bram_0_aclk] [get_bd_pins DigitRec_1_if/s_axi_aclk] [get_bd_pins DigitRec_1_if/s_axis_bram_0_aclk] [get_bd_pins DigitRec_1_if/s_axis_bram_1_aclk] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M01_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M02_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M03_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/S00_ACLK] [get_bd_pins axis_dwc_dm_0_tx_0/aclk] [get_bd_pins axis_dwc_dm_1_tx_0/aclk] [get_bd_pins axis_dwc_dm_2_rx_0/aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins dm_0/m_axi_mm2s_aclk] [get_bd_pins dm_0/s_axi_lite_aclk] [get_bd_pins dm_1/m_axi_mm2s_aclk] [get_bd_pins dm_1/s_axi_lite_aclk] [get_bd_pins dm_2/m_axi_s2mm_aclk] [get_bd_pins dm_2/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e/maxihpm0_fpd_aclk] [get_bd_pins ps_e/saxihp0_fpd_aclk] [get_bd_pins ps_e/saxihp1_fpd_aclk] [get_bd_pins ps_e/saxihp2_fpd_aclk]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M01_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M02_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M03_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP2_FPD/S00_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins DigitRec_1_if/acc_aresetn] [get_bd_pins DigitRec_1_if/m_axis_bram_0_aresetn] [get_bd_pins DigitRec_1_if/s_axi_aresetn] [get_bd_pins DigitRec_1_if/s_axis_bram_0_aresetn] [get_bd_pins DigitRec_1_if/s_axis_bram_1_aresetn] [get_bd_pins axis_dwc_dm_0_tx_0/aresetn] [get_bd_pins axis_dwc_dm_1_tx_0/aresetn] [get_bd_pins axis_dwc_dm_2_rx_0/aresetn] [get_bd_pins dm_0/axi_resetn] [get_bd_pins dm_1/axi_resetn] [get_bd_pins dm_2/axi_resetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x000200000000 -offset 0x000600000000 [get_bd_addr_spaces dm_1/Data_MM2S] [get_bd_addr_segs ps_e/SAXIGP2/HP0_PCIE_HIGH1] SEG_ps_e_HP0_PCIE_HIGH1
  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces dm_1/Data_MM2S] [get_bd_addr_segs ps_e/SAXIGP2/HP0_PCIE_LOW] SEG_ps_e_HP0_PCIE_LOW
  ...
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces dm_2/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP4/HP2_DDR_HIGH] SEG_ps_e_HP2_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_2/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP4/HP2_DDR_LOW] SEG_ps_e_HP2_DDR_LOW
  create_bd_addr_seg -range 0x000200000000 -offset 0x000600000000 [get_bd_addr_spaces dm_2/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP4/HP2_PCIE_HIGH1] SEG_ps_e_HP2_PCIE_HIGH1
  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces dm_2/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP4/HP2_PCIE_LOW] SEG_ps_e_HP2_PCIE_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces dm_2/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP4/HP2_QSPI] SEG_ps_e_HP2_QSPI
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs DigitRec_1_if/S_AXI/reg0] SEG_DigitRec_1_if_reg0
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0011000 [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs dm_1/S_AXI_LITE/Reg] SEG_dm_1_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0012000 [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs dm_2/S_AXI_LITE/Reg] SEG_dm_2_Reg
  ...
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_2/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP4/HP2_LPS_OCM] SEG_ps_e_HP2_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_2/Data_S2MM/SEG_ps_e_HP2_LPS_OCM]
