...
HD_PWD='/home/ylxiao_seas_upenn_edu/Roseetta/rosetta/digit-recognition/_sds/p0/vivado/prj/prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zcu102_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zcu102_wrapper.tcl -notrace
