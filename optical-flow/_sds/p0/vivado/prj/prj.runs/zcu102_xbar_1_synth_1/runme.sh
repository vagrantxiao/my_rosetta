...
HD_PWD='/home/ylxiao_seas_upenn_edu/Roseetta/rosetta/optical-flow/_sds/p0/vivado/prj/prj.runs/zcu102_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zcu102_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zcu102_xbar_1.tcl
