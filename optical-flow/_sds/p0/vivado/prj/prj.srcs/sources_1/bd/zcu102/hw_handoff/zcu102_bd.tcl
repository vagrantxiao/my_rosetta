...
proc create_root_design { parentCell } {
  ...
  # Create instance: optical_flow_1, and set properties
  set optical_flow_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:optical_flow:1.0 optical_flow_1 ]

  # Create instance: optical_flow_1_if, and set properties
  ...
  connect_bd_intf_net -intf_net axi_ic_ps_e_M_AXI_HPM0_FPD_M00_AXI [get_bd_intf_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_AXI] [get_bd_intf_pins optical_flow_1_if/S_AXI]
  ...
  connect_bd_intf_net -intf_net axis_ic_dm_0_M00_AXIS [get_bd_intf_pins axis_ic_dm_0/M00_AXIS] [get_bd_intf_pins optical_flow_1_if/S_AXIS_FIFO_0]
  ...
  connect_bd_intf_net -intf_net dm_0_M_AXI_SG [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP0_FPD/S01_AXI] [get_bd_intf_pins dm_0/M_AXI_SG]
  connect_bd_intf_net -intf_net dm_1_M_AXI_S2MM [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP1_FPD/S00_AXI] [get_bd_intf_pins dm_1/M_AXI_S2MM]
  connect_bd_intf_net -intf_net dm_1_M_AXI_SG [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP1_FPD/S01_AXI] [get_bd_intf_pins dm_1/M_AXI_SG]
  connect_bd_intf_net -intf_net optical_flow_1_frames_V [get_bd_intf_pins optical_flow_1/frames_V] [get_bd_intf_pins optical_flow_1_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net optical_flow_1_if_M_AXIS_FIFO_0 [get_bd_intf_pins axis2sgdma_dm_1/S_AXIS_DATA] [get_bd_intf_pins optical_flow_1_if/M_AXIS_FIFO_0]
  connect_bd_intf_net -intf_net optical_flow_1_if_ap_ctrl [get_bd_intf_pins optical_flow_1/ap_ctrl] [get_bd_intf_pins optical_flow_1_if/ap_ctrl]
  connect_bd_intf_net -intf_net optical_flow_1_outputs [get_bd_intf_pins optical_flow_1/outputs] [get_bd_intf_pins optical_flow_1_if/AP_FIFO_OARG_0]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M01_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M02_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S01_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S01_ACLK] [get_bd_pins axis2sgdma_dm_1/clk] [get_bd_pins axis_ic_dm_0/ACLK] [get_bd_pins axis_ic_dm_0/M00_AXIS_ACLK] [get_bd_pins axis_ic_dm_0/S00_AXIS_ACLK] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins dm_0/m_axi_mm2s_aclk] [get_bd_pins dm_0/m_axi_sg_aclk] [get_bd_pins dm_0/s_axi_lite_aclk] [get_bd_pins dm_1/m_axi_s2mm_aclk] [get_bd_pins dm_1/m_axi_sg_aclk] [get_bd_pins dm_1/s_axi_lite_aclk] [get_bd_pins optical_flow_1_if/acc_aclk] [get_bd_pins optical_flow_1_if/m_axis_fifo_0_aclk] [get_bd_pins optical_flow_1_if/s_axi_aclk] [get_bd_pins optical_flow_1_if/s_axis_fifo_0_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e/maxihpm0_fpd_aclk] [get_bd_pins ps_e/saxihp0_fpd_aclk] [get_bd_pins ps_e/saxihp1_fpd_aclk] [get_bd_pins sgdma2axis_dm_0/clk]
  ...
  connect_bd_net -net dm_1_s2mm_introut [get_bd_pins dm_1/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net optical_flow_1_if_ap_clk [get_bd_pins optical_flow_1/ap_clk] [get_bd_pins optical_flow_1_if/ap_clk]
  connect_bd_net -net optical_flow_1_if_ap_resetn [get_bd_pins optical_flow_1/ap_rst_n] [get_bd_pins optical_flow_1_if/ap_resetn]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M01_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M02_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S01_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S01_ARESETN] [get_bd_pins axis_ic_dm_0/ARESETN] [get_bd_pins axis_ic_dm_0/M00_AXIS_ARESETN] [get_bd_pins axis_ic_dm_0/S00_AXIS_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axis2sgdma_dm_1/arstn] [get_bd_pins dm_0/axi_resetn] [get_bd_pins dm_1/axi_resetn] [get_bd_pins optical_flow_1_if/acc_aresetn] [get_bd_pins optical_flow_1_if/m_axis_fifo_0_aresetn] [get_bd_pins optical_flow_1_if/s_axi_aresetn] [get_bd_pins optical_flow_1_if/s_axis_fifo_0_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins sgdma2axis_dm_0/arstn]
  connect_bd_net -net ps_e_pl_clk0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps_e/pl_clk0]
  connect_bd_net -net sds_irq_const_dout [get_bd_pins sds_irq_const/dout] [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconcat_0/In3] [get_bd_pins xlconcat_0/In4] [get_bd_pins xlconcat_0/In5] [get_bd_pins xlconcat_0/In6] [get_bd_pins xlconcat_0/In7] [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconcat_1/In3] [get_bd_pins xlconcat_1/In4] [get_bd_pins xlconcat_1/In5] [get_bd_pins xlconcat_1/In6] [get_bd_pins xlconcat_1/In7]
  ...
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP2/HP0_DDR_HIGH] SEG_ps_e_HP0_DDR_HIGH
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP2/HP0_DDR_LOW] SEG_ps_e_HP0_DDR_LOW
  ...
  create_bd_addr_seg -range 0x000200000000 -offset 0x000600000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP2/HP0_PCIE_HIGH1] SEG_ps_e_HP0_PCIE_HIGH1
  create_bd_addr_seg -range 0x000200000000 -offset 0x000600000000 [get_bd_addr_spaces dm_0/Data_MM2S] [get_bd_addr_segs ps_e/SAXIGP2/HP0_PCIE_HIGH1] SEG_ps_e_HP0_PCIE_HIGH1
  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP2/HP0_PCIE_LOW] SEG_ps_e_HP0_PCIE_LOW
  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces dm_0/Data_MM2S] [get_bd_addr_segs ps_e/SAXIGP2/HP0_PCIE_LOW] SEG_ps_e_HP0_PCIE_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP2/HP0_QSPI] SEG_ps_e_HP0_QSPI
  ...
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces dm_1/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_DDR_HIGH] SEG_ps_e_HP1_DDR_HIGH
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces dm_1/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP3/HP1_DDR_HIGH] SEG_ps_e_HP1_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_1/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_DDR_LOW] SEG_ps_e_HP1_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_1/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP3/HP1_DDR_LOW] SEG_ps_e_HP1_DDR_LOW
  create_bd_addr_seg -range 0x000200000000 -offset 0x000600000000 [get_bd_addr_spaces dm_1/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_PCIE_HIGH1] SEG_ps_e_HP1_PCIE_HIGH1
  create_bd_addr_seg -range 0x000200000000 -offset 0x000600000000 [get_bd_addr_spaces dm_1/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP3/HP1_PCIE_HIGH1] SEG_ps_e_HP1_PCIE_HIGH1
  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces dm_1/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_PCIE_LOW] SEG_ps_e_HP1_PCIE_LOW
  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces dm_1/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP3/HP1_PCIE_LOW] SEG_ps_e_HP1_PCIE_LOW
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces dm_1/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_QSPI] SEG_ps_e_HP1_QSPI
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces dm_1/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP3/HP1_QSPI] SEG_ps_e_HP1_QSPI
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs optical_flow_1_if/S_AXI/reg0] SEG_optical_flow_1_if_reg0
  ...
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_0/Data_SG] [get_bd_addr_segs ps_e/SAXIGP2/HP0_LPS_OCM] SEG_ps_e_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_0/Data_SG/SEG_ps_e_HP0_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_1/Data_S2MM] [get_bd_addr_segs ps_e/SAXIGP3/HP1_LPS_OCM] SEG_ps_e_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_1/Data_S2MM/SEG_ps_e_HP1_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_1/Data_SG] [get_bd_addr_segs ps_e/SAXIGP3/HP1_LPS_OCM] SEG_ps_e_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_1/Data_SG/SEG_ps_e_HP1_LPS_OCM]
