...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_dwc_dm_1_rx_0, and set properties
  ...
  # Create instance: rendering_1, and set properties
  set rendering_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:rendering:1.0 rendering_1 ]

  # Create instance: rendering_1_if, and set properties
  ...
  connect_bd_intf_net -intf_net axi_ic_ps_e_M_AXI_HPM0_FPD_M00_AXI [get_bd_intf_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_AXI] [get_bd_intf_pins rendering_1_if/S_AXI]
  ...
  connect_bd_intf_net -intf_net axis_dwc_dm_0_tx_0_M_AXIS [get_bd_intf_pins axis_dwc_dm_0_tx_0/M_AXIS] [get_bd_intf_pins rendering_1_if/S_AXIS_BRAM_0]
  connect_bd_intf_net -intf_net axis_dwc_dm_1_rx_0_M_AXIS [get_bd_intf_pins axis_dwc_dm_1_rx_0/M_AXIS] [get_bd_intf_pins dm_1/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net rendering_1_if_M_AXIS_BRAM_0 [get_bd_intf_pins axis_dwc_dm_1_rx_0/S_AXIS] [get_bd_intf_pins rendering_1_if/M_AXIS_BRAM_0]
  connect_bd_intf_net -intf_net rendering_1_if_ap_ctrl [get_bd_intf_pins rendering_1/ap_ctrl] [get_bd_intf_pins rendering_1_if/ap_ctrl]
  connect_bd_intf_net -intf_net rendering_1_input_V_PORTA [get_bd_intf_pins rendering_1/input_V_PORTA] [get_bd_intf_pins rendering_1_if/AP_BRAM_IARG_0_0]
  connect_bd_intf_net -intf_net rendering_1_output_V_PORTA [get_bd_intf_pins rendering_1/output_V_PORTA] [get_bd_intf_pins rendering_1_if/AP_BRAM_OARG_0_0]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M01_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M02_ACLK] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S00_ACLK] [get_bd_pins axis_dwc_dm_0_tx_0/aclk] [get_bd_pins axis_dwc_dm_1_rx_0/aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins dm_0/m_axi_mm2s_aclk] [get_bd_pins dm_0/s_axi_lite_aclk] [get_bd_pins dm_1/m_axi_s2mm_aclk] [get_bd_pins dm_1/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e/maxihpm0_fpd_aclk] [get_bd_pins ps_e/saxihp0_fpd_aclk] [get_bd_pins ps_e/saxihp1_fpd_aclk] [get_bd_pins rendering_1_if/acc_aclk] [get_bd_pins rendering_1_if/m_axis_bram_0_aclk] [get_bd_pins rendering_1_if/s_axi_aclk] [get_bd_pins rendering_1_if/s_axis_bram_0_aclk]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M01_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/M02_ARESETN] [get_bd_pins axi_ic_ps_e_M_AXI_HPM0_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP1_FPD/S00_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axis_dwc_dm_0_tx_0/aresetn] [get_bd_pins axis_dwc_dm_1_rx_0/aresetn] [get_bd_pins dm_0/axi_resetn] [get_bd_pins dm_1/axi_resetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins rendering_1_if/acc_aresetn] [get_bd_pins rendering_1_if/m_axis_bram_0_aresetn] [get_bd_pins rendering_1_if/s_axi_aresetn] [get_bd_pins rendering_1_if/s_axis_bram_0_aresetn]
  connect_bd_net -net ps_e_pl_clk0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps_e/pl_clk0]
  connect_bd_net -net rendering_1_if_ap_clk [get_bd_pins rendering_1/ap_clk] [get_bd_pins rendering_1_if/ap_clk]
  connect_bd_net -net rendering_1_if_ap_resetn [get_bd_pins rendering_1/ap_rst_n] [get_bd_pins rendering_1_if/ap_resetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs rendering_1_if/S_AXI/reg0] SEG_rendering_1_if_reg0
