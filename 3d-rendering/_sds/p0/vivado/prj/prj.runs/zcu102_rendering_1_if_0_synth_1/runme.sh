...
HD_PWD='/home/ylxiao_seas_upenn_edu/Roseetta/rosetta/3d-rendering/_sds/p0/vivado/prj/prj.runs/zcu102_rendering_1_if_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zcu102_rendering_1_if_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zcu102_rendering_1_if_0.tcl
