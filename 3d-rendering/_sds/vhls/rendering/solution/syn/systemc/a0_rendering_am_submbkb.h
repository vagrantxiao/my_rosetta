...
#ifndef __a0_rendering_am_submbkb__HH__
#define __a0_rendering_am_submbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(a0_rendering_am_submbkb) {
    ...
    SC_CTOR(a0_rendering_am_submbkb):  simcore_am_0_U ("simcore_am_0_U") {
