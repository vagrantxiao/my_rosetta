...
#ifndef __a0_rendering_ama_subfYi__HH__
#define __a0_rendering_ama_subfYi__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(a0_rendering_ama_subfYi) {
    ...
    SC_CTOR(a0_rendering_ama_subfYi):  simcore_ama_0_U ("simcore_ama_0_U") {
